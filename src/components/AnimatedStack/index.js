...
import Animated, {useSharedValue, useAnimatedStyle, runOnJS, useAnimatedGestureHandler, withSpring, useDerivedValue, interpolate } from 'react-native-reanimated';
...
const AnimatedStack = props => {
  ...
  return (
    <View style={styles.root}>
      ...
      {currentProfile && <GestureHandlerRootView>
